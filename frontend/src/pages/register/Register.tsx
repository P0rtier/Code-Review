  ...
  return (
    <div className={styles.container}>
      <div className={styles.componentContainer}>
        <Box className={styles.header} __css={primaryStyles}>
          Sign up
        </Box>
        <Box className={styles.content} __css={secondaryStyles}>
          ...
          <div className={styles.inputContainer}>
            ...
            <PasswordInput onChange={handleChanges} name="password" />
          </div>
          <div className={styles.inputContainer}>
          ...
          <div className={styles.buttonContainer}>
            ...
            <Button variant="auth" onClick={handleRegister}>
              Register
            </Button>
          </div>
        </Box>
